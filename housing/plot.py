...
def plot_grids(adj_ur_grids,cp, term_t = 58):
	...
	for j in list(range(term_t, cp.T)):
		...
		e_grid_cean = adj_ur_grids[plot_t]["EGMGrids"]["e_grid_cean"]
		...
		ax[0, 0].scatter(e_grid_cean, vf_clean, color=colors[1], s=15,
						 marker='o',
						 linewidth=0.75)
		...
		ax[0, 1].scatter(e_grid_unrefined, h_prime_unrefined_adj, color=colors[1],
						 ...
						 marker='x',
						 linewidth=0.75)
		ax[0, 1].scatter(e_grid_cean, hprime_clean, color=colors[2], s=15,
						 marker='o',
						 linewidth=0.75)
		...
		ax[1, 0].scatter(h_prime_unrefined_adj, e_grid_unrefined, color=colors[0],
						 ...
						 marker='x',
						 linewidth=0.75)
		ax[1, 0].scatter(hprime_clean, e_grid_cean, color=colors[1],
						 s=15,
						 marker='x',
						 linewidth=0.75)
		...
		ax[1].plot(e_grid_cean, hprime_clean, color=colors[2], linewidth=1)
